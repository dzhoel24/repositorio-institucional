...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\PROYECTOS\REPOSITORIO\public\storage' => 'string',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.D:\\PROYECTOS\\REPOSITORIO\\public\\storage',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'home','login','home','perfil',
'manual','profile.password.update','informes.index','informes.create','informes.store',
'informes.edit','informes.update','informes.destroy','informes.buscar-dni','autores.index',
'autores.create','autores.store','autores.show','autores.edit','autores.update',
'autores.destroy','publicaciones.index','publicaciones.publish','publicaciones.unpublish','register','password.request','password.email','password.reset',
'password.store','password.confirm','password.update','logout',
'institucional.index','institucional.show','investigacion.index','investigacion.show','modulo.index',
'modulo.show','feria.index','feria.show','filtros.fechaP','filtros.showFechaP',
'filtros.rangeYear','filtros.autores','filtros.autores.search','filtros.showAutor','filtros.showInformeAutores',
'filtros.informesA','filtros.listTitle.search','filtros.show','filtros.listTitle','filtros.category',
'carrera.show','carrera.index','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'autor.destroy','autor.store','autor.update','components.advanced-filter','components.advanced-filter-carrera',
'components.alerts.alert','components.alerts.salir','components.app-main','components.auth-session-status','components.breadcrumb',
'components.card','components.contador','components.filter','components.header-admin','components.item',
'components.js-edit-form','components.list-table','components.modal.delete','components.modal.salir','components.modal.subir',
'components.pagination','components.search','components.search-admin','components.sidebar','components.toast-errors',
'feria.index','feria.show','filtros.autores','filtros.fechaP','filtros.informesA',
'filtros.listTitulo','filtros.showFechaP','filtros.showInformeAutores','filtros.showTitulos','filtros.showfecha',
'home','informes.destroy','informes.store','informes.update','institucional.index',
'institucional.show','investigacion.index','investigacion.show','layouts.admin','login.index',
'modulo.index','modulo.show','pagination::tailwind','panel.home','panel.indexAutor',
'panel.indexInformes','panel.indexPublicaciones','panel.manual','panel.perfil','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','publicaciones.publish','publicaciones.unpublish',
'section.carrera','section.index','section.showItem','test','vendor.pagination.tailwind',
'breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma','breadcrumbs::foundation6','breadcrumbs::materialize',
'breadcrumbs::tailwind','breadcrumbs::uikit','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.PROYECTOS.REPOSITORIO.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','auth.failed','auth.password','auth.throttle',);
