        ...
        <div class="pointer-events-none relative flex min-h-screen items-center justify-center p-4">
            ...
            <div
                ...
                <div class="relative pt-8 text-center">
                    ...
                    <div
                        class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-amber-200 bg-amber-50 
                ...
                <div
                    class="mx-6 my-6 rounded-xl border border-slate-300 bg-slate-100/50 p-4 text-center 
                ...
                {{-- FORMULARIO --}}
                <form id="unpublish-form-{{ $info->id }}"
