<x-admin.modal-create id='add-informe-modal' title='NUEVO INFORME' subtitle='Completa los campos' size="full"
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-0">
        ...
        {{-- COLUMNA IZQUIERDA --}}
        <div class="space-y-3 lg:space-y-5 lg:border-r lg:border-slate-200 dark:lg:border-slate-700 
        p-4 sm:p-5">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <input id="titulo" type="text" name="titulo" required
                            ...
                            class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 sm:px-4 sm:py-3 text-sm text-slate-800 
                                   outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-400/20 
                                   dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="resumen" name="resumen" rows="4" required placeholder="Describe brevemente el proyecto"
                            class="w-full resize-none rounded-xl border border-slate-200 bg-white px-3 py-2.5 sm:px-4 sm:py-3 text-sm text-slate-800 
                                   outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-400/20 
                                   dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-indigo-500"></textarea>
                    </div>
            ...
            <div>
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    ...
                    <input id="dni" type="text" placeholder="Ingrese DNI del autor"
                        class="flex-1 rounded-xl border border-slate-200 bg-white px-3 py-2.5 sm:px-4 sm:py-3 text-sm text-slate-800 
                               outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-400/20 
                               dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500">
                    <button type="button" id="buscar"
                        class="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-800 px-4 py-2.5 text-sm font-bold text-white 
                ...
                <div id="autores-container"
                    class="mt-3 min-h-[80px] rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm text-slate-700 
            ...
            <div class="space-y-4">
                ...
                <div
                    ...
                    <div class="mb-2 flex flex-wrap items-center gap-2">
                        ...
                        <label for="pdf" class="text-sm font-bold text-slate-600 dark:text-slate-300">Archivo
                            PDF</label>
                        <span
                            class="rounded-md bg-rose-100 px-2 py-0.5 text-[10px] font-bold text-rose-600 dark:bg-rose-500/20 dark:text-rose-400">Requerido</span>
                    </div>
                ...
                <div
                    ...
                    <div class="flex min-h-[160px] items-center justify-center p-4">
                        <img id="imgPreview" class="hidden max-h-36 rounded-lg object-cover shadow-md">
                        <div id="imgPlaceholder"
                            class="flex flex-col items-center gap-2 text-slate-300 dark:text-slate-600">
