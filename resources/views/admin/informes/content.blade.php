...
<x-admin.title titulo="DIRECTORIO PROYECTOS"
    subtitulo="Consulta, registra y administra los proyectos almacenados en el sistema." 
    :table="$informes"
    singular="proyecto" 
    plural="proyectos" 
    badgeColor="blue" />
...
<div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-700/50 dark:bg-slate-900/50">
                    ...
                    <tr class="group transition-all duration-150 hover:bg-slate-50/60 dark:hover:bg-slate-800/30">
                        ...
                        <td class="px-5 py-4 align-middle">
                            <div class="flex flex-col gap-2.5">
                                ...
                                <span class="{{ $badgeStyle }} inline-block w-fit rounded-md px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide">
                                    {{ $info->tipo_nombre }}
                                </span>
                            </div>
                        </td>
                        ...
                        <td class="px-5 py-4 text-center align-middle">
                            <div class="flex flex-col items-center justify-center gap-2.5">
                                <button type="button" data-tw-toggle="modal" data-tw-target="#edit-modal{{ $info->id }}"
                                ...
                                <button type="button" data-tw-toggle="modal" data-tw-target="#delete-modal{{ $info->id }}"
                            ...
                            <div class="flex flex-col items-center justify-center">
                                ...
                                @if (request('buscador'))
                                    <a href="{{ route('admin.informes.index') }}"
                                       hx-get="{{ route('admin.informes.index') }}" 
