@foreach ($autores as $autor)
    <x-admin.modal-crud id="edit-modal{{ $autor->dni }}" title="EDITAR AUTOR" subtitle="Modifica los datos del autor"
        action="{{ route('admin.autores.update', $autor->dni) }}" method="PUT" icon="heroicon-o-pencil-square"
        buttonText="Guardar Cambios" buttonIcon="heroicon-o-check-circle">
        ...
        <div class="space-y-4">
            <div class="space-y-1.5">
                ...
                <p class="text-[10px] text-slate-400 dark:text-slate-500 mt-0.5">El DNI no puede ser modificado</p>
            </div>
