<x-public.app-main title="Índice de Autores" :showFilter="true">
    ...
    <div class="flex flex-col w-full px-0 md:px-4 space-y-5 mt-4 sm:mt-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 pb-3">
            <div class="flex items-center gap-2.5 min-w-0 flex-wrap">
                ...
                <div class="flex items-center gap-2 flex-wrap">
                    <h2 class="text-base sm:text-lg font-bold text-slate-800 tracking-wide">LISTAR POR:</h2>
        ...
        <div class="w-full flex flex-row items-center justify-between gap-3 py-2 border-b border-slate-100">
            ...
            <div class="flex items-center justify-end">
                <x-public.advanced-filter route="filtros.autores.index" defaultSort="asc" defaultItemsPerPage="10" />
            </div>
        </div>
        ...
        @if ($autores->isEmpty())
            <div class="text-center py-12 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                ...
                <p class="text-sm font-medium text-slate-500">No se encontraron autores con esos criterios.</p>
                @if ($hasFilter)
                    <a href="{{ route('filtros.autores.index') }}"
