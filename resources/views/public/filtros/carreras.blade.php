<x-public.app-main title="Programas de Estudio" :showFilter="true">

    <x-public.breadcrumb name="filtros.carreras.index" />

    <div class="flex flex-col w-full space-y-5 mt-4 sm:mt-6">
        ...
        @if ($carreras->isEmpty())
            <div class="text-center py-12 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                ...
                <p class="text-sm font-medium text-slate-500">No se encontraron programas de estudio registrados.</p>
            </div>
        @else
