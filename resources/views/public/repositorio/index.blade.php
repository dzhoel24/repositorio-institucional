<x-public.app-main :title="$config['titulo']" :showFilter="true">

    <x-public.breadcrumb name="repositorio.index" :params="[$tipo, $origen ?? null, $origenModel ?? null]" />

    <div class="flex flex-col space-y-5 mt-4 sm:mt-6">
        ...
        <div class="flex flex-col gap-4 w-full">
            @forelse ($informes as $informe)
                @php
                    $cardParams = ['tipo' => $tipo, 'id' => $informe->id];
                    if ($origen === 'carrera' && isset($carreraModel)) {
            ...
            @empty
                <div class="text-center py-12 md:py-16 bg-slate-50 rounded-xl border border-dashed border-slate-200">
