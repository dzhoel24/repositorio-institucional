<x-public.app-main title="Investigacion">
        ...
        <div class="md:col-span-3 flex flex-col w-full px-4">
            <div
                ...
                <div class="flex items-center justify-end">
                    <x-advanced-filter route="repositorio.index" :params="['tipo' => 'investigacion']" defaultSort="asc"
            ...
            <div class="flex flex-col gap-4 w-full pt-2">
                @forelse ($informes as $informe)
                    <x-public.card :parametro="'investigacion'" :codigo="$informe->id" :image="$informe->ruta_caratula" :title="$informe->titulo"
