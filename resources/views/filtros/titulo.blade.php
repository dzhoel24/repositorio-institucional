<x-public.app-main title="Índice de Títulos">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 w-full gap-6 lg:gap-8 mt-4 sm:mt-6">
        ...
        <main class="md:col-span-3 flex flex-col w-full px-2 sm:px-4 space-y-5">
            ...
            {{-- Encabezado de la Sección Moderno --}}
            ...
            {{-- Paginación Alfabética y Numérica (Deslizable en Móviles) --}}
            <div class="w-full pb-1">
                <ul id="list"
                    ...
                    <li class="shrink-0">
                        <a href="{{ route('filtros.listTitle.search', ['starts_with' => '0-9']) }}"
                    ...
                    @foreach (range('A', 'Z') as $letter)
                        ...
                        <li class="shrink-0">
                            <a href="{{ route('filtros.listTitle.search', ['starts_with' => $letter]) }}"
            ...
            <div class="w-full pt-1">
                <x-search :parametro="'filtros'" :parametro2="'listTitle'" :descrip="'Introducir las primeras letras del título...'" :text="'Buscar'" />
            </div>
