    ...
    <ul class="inline-flex -space-x-px text-base h-10">
        ...
        <li>
            @if ($paginator->onFirstPage())
                <span
                    class="flex items-center justify-center px-4 h-10 text-gray-500 bg-white border border-gray-300 rounded-s-lg cursor-default"
        ...
        @for ($i = 1; $i <= $paginator->lastPage(); $i++)
            <li>
                @if ($i == $paginator->currentPage())
                    <span
                        class="flex items-center justify-center px-4 h-10 text-blue-600 border border-gray-300 bg-blue-50">{{ $i }}</span>
                @else
        ...
        <li>
            ...
            @else
                <span
                    class="flex items-center justify-center px-4 h-10 text-gray-500 bg-white border border-gray-300 rounded-e-lg cursor-default"
