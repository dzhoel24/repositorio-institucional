...
<body class="bg-slate-50 text-slate-800 antialiased flex flex-col min-h-full">
    ...
    <header
        class="bg-white/80 backdrop-blur-md border-b border-slate-200/80 sticky top-0 z-50 flex items-center justify-between h-20 px-6 lg:px-12 transition-all">
            ...
            <div class="flex items-center gap-3">
                <div
                    ...
                    <img class="w-10 h-10 md:w-11 md:h-11 object-contain" src="{{ asset('images/icono-csr.ico') }}"
                        alt="Logo Institucional" loading="lazy">
                </div>
                <div class="flex flex-col">
                    <h1 class="text-base md:text-lg font-black leading-none tracking-tight uppercase text-slate-900">
                        Repositorio <span class="text-sky-600 transition-colors group-hover:text-sky-500">Digital</span>
                    </h1>
        ...
        <a href="{{ route('login') }}"
            class="group inline-flex items-center gap-2 px-5 py-2 text-sm font-bold uppercase tracking-wider text-sky-700 bg-sky-50/60 rounded-xl border border-sky-200/60 shadow-sm shadow-sky-100/40 transition-all duration-200 hover:bg-sky-100/80 hover:border-sky-300/80 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2">
            <span>Ingresar</span>
            <x-heroicon-s-arrow-right-on-rectangle
                class="w-4 h-4 text-sky-600/80 transition-all duration-200 group-hover:text-sky-700 group-hover:translate-x-0.5" />
        </a>
    </header>
    ...
    <footer class="bg-slate-100 border-t border-slate-200/60 py-6 mt-8">
        <div
